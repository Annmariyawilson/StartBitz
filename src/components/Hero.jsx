...
const roles = ["Full-Stack Development", "Web Design", "Tech Consulting"];
    ...
    >
      ...
      <div className="relative flex flex-col md:flex-row items-center justify-center gap-12 lg:gap-16 max-w-6xl w-full z-10">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left max-w-lg">
          {/* Main Heading */}
          <motion.h1
            className="text-4xl sm:text-5xl lg:text-6xl font-bold text-[#b28b64] mb-3 leading-tight"
          ...
          >
            ...
            {/* Text */}
            <span className="relative z-10">View Our Resume</span>
          </motion.a>
        </div>
      </div>
    </section>
